...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            partSize = Integer.valueOf(mNewPartySizeEditText.getText().toString());
        }
        // COMPLETED (12) Make sure you surround the Integer.parseInt with a try catch and log any exception
        catch (NumberFormatException e) {
            Log.e("AddNewGuest", "Party size not of type int!");
            return;
        }

        // COMPLETED (14) call addNewGuest with the guest name and party size
        addNewGuest(mNewGuestNameEditText.getText().toString(), partSize);
