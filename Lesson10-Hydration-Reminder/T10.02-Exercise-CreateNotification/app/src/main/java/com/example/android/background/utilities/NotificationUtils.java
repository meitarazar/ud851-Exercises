...
public class NotificationUtils {
    ...
    private static final int NOTIFICATION_ID = 945;

    private static final int PENDING_INTENT_ID = 6147;

    private static final String NOTIFICATION_CHANNEL_ID = "channelReminder";
